    ...
    const paginaPrincipal = `
        ...
        <body>
            ...
            <ul>
                ...
                <li>Moises Reinaldo Reyes Flores (Desarrollador)</li>
                <li>Miguel Ángel Ballivian Ocampo (Desarrollador)</li>
                <li>Wilson Montaño Claros (Desarrollador)</li>
                <li>Melissa Fisher Vargas (Desarrolladora -> LE TOCO HACER)</li>
            ...
            <hr>
            <p>Redes y Comunicacion entre Contenedores implementado exitosamente :)</p>
        </body>
        </html>
    `;
...
aplicacion.listen(PUERTO, () => {
    ...
    console.log(`Acceder desde navegador en: http://localhost:3000`);
